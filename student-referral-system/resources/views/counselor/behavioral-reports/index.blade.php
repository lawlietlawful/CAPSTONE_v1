...
{{-- ── Filters ───────────────────────────────────────────────── --}}
<div class="mb-6">
    <form action="{{ route('counselor.behavioral-reports.index') }}" method="GET" class="w-full" x-data id="filterForm">
...
<div x-data="bulkActions()" class="bg-white border border-gray-100 rounded-2xl shadow-premium overflow-hidden transition-all duration-300 hover:shadow-hover">
    ...
    <div x-show="selectedIds.length > 0"
        ...
        <div class="flex items-center gap-2">
            <form action="{{ route('counselor.behavioral-reports.bulkAction') }}" method="POST" class="inline-flex m-0">
                @csrf
