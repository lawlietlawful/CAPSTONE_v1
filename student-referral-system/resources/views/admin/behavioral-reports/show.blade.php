...
<div class="mb-6 flex items-center justify-between">
    ...
    <a href="{{ route('admin.behavioral-reports.print', $behavioral_report->id) }}" target="_blank"
            ...
            <div class="p-6 space-y-5">
                ...
                @if($behavioral_report->escalatedReferral)
                    <div class="pt-4 border-t border-gray-100">
                        <a href="{{ route('admin.referrals.show', $behavioral_report->escalatedReferral->id) }}"
                ...
                @unless($behavioral_report->escalatedReferral)
                    @include('partials.report-refer-card', ['referRoute' => 'admin.behavioral-reports.refer'])
                @endunless
            ...
            <div class="bg-white border border-gray-100 rounded-2xl shadow-premium overflow-hidden transition-all duration-300 hover:shadow-hover">
                ...
                <div class="p-6 space-y-3">
                    @foreach($otherReports as $other)
                        ...
                        @endphp
                        <a href="{{ route('admin.behavioral-reports.show', $other->id) }}" class="block p-3.5 rounded-xl border border-gray-100 hover:border-gray-200 hover:bg-gray-50/50 hover:shadow-sm transition">
                ...
                @if($otherReportsCount > $otherReports->count())
                    <a href="{{ route('admin.behavioral-reports.index', ['search' => $behavioral_report->student->student_id_number]) }}" class="block text-center text-xs font-medium text-blue-600 hover:text-blue-800 pb-5 -mt-1">
